...
#' @param my_vlpbek_compact a vlpbek_compact object
...
#' \item{brin_own}{brin_own from the my_vlpbek_compact object}
...
#'  my_vlpbek_compact = my_vlp_compact_thing,
#'   prop_exam = TRUE)
#' }
after_degree <- function(program_of_interest, my_vlpbek_compact, prop_exam = FALSE){
  ...
  stopifnot(class(my_vlpbek_compact) == "vlpbek_compact")
  ...
  min_academic_year <- min(my_vlpbek_compact$enrolments_degrees_compact$academic_year)
  max_academic_year <- max(my_vlpbek_compact$enrolments_degrees_compact$academic_year)
  brin_own <- my_vlpbek_compact$brin_own

  # find all students with an enrolment on this program at brin_own with a P
  students_of_interest <- my_vlpbek_compact$enrolments_degrees_compact |>
  ...
  enrolments_of_interest <- students_of_interest |>
    dplyr::left_join(my_vlpbek_compact$enrolments_degrees_compact,
